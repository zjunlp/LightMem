...
| Method             | ACC(%) gpt-4o-mini | ACC(%) qwen2.5-32b-instruct | Memory-Con Tokens(k) Total | QA Tokens(k) total | Total(k)     | Calls  | Runtime(s) mem-con | Runtime(s) qa | Runtime(s) total |
|-------------------|--------------------|------------------------------|----------------------|-------------|--------------|--------|---------------------|---------------|------------------|
| FullText          | 73.83              | 73.18                       | –                    | 54,884.479  | 54,884.479   | –      | –                   | 6,971         | 6,971           |
| NaiveRAG          | 63.64              | 63.12                       | –                    | 3,870.187   | 3,870.187    | –      | –                   | 1,884         | 1,884           |
| LangMem           | 37.20              | –                           | 1,102.16             | –           | 1,102.16     | 520.62 | 2,293.70            | ccc           | –               |
| A-MEM             | 64.16              | 60.71                       | 11,494.344           | 10,170.567  | 21,664.907   | 11,754 | 60,607.33           | 6,477         | 67,085          |
| MemoryOS(eval)    | 58.25              | 61.04                       | 2,870.036            | 7,649.343   | 10,519.379   | 5,534  | 24,220.47           | 1,909         | 26,129          |
| MemoryOS(pypi)    | 54.87              | 55.91                       | 5,264.801            | 6,126.111   | 11,390.004   | 10,160 | 33,325.92           | 4,587         | 37,912          |
| Mem0              | 61.69              | 61.69                       | 68,347.720                    | 4,169.909   | 72,517.629   | 6,022  | 4,328               | 6,117         | 10,445          |
| Mem0-g            | 60.32              | 59.48                       | 69,684.818                    | 4,389.147   | 74,073.965   | 6,022  | 5,381               | 5,545         | 10,926          |
| LightMem(512,0.7) | 71.95              | 73.90                       | 997.60               | 4,008.243   | 5,005.851    | 415    | 8,484               | 4,347         | 12,831          |
| LightMem(768,0.7) | 70.26              | 72.40                       | 804.77               | 3,958.228   | 4,763.005    | 295    | 7,378               | 4,265         | 11,643          |
| LightMem(768,0.8) | 72.99              | 74.35                       | 851.87               | 4,012.034   | 4,863.900    | 298    | 8,153               | 4,270         | 12,423          |

#### Detailed Token Usage

| Method             | Summary Tokens(k) In | Summary Tokens(k) Out | Update Tokens(k) In | Update Tokens(k) Out | Memory-Con Tokens(k) Total | QA Tokens(k) In | QA Tokens(k) Out | QA Tokens(k) total | Total(k)     |
|-------------------|-----------------------|------------------------|----------------------|-----------------------|-----------------------------|------------------|-------------------|---------------------|--------------|
| FullText          | –                     | –                      | –                    | –                     | –                           | 54,858.770       | 25.709            | 54,884.479          | 54,884.479   |
| NaiveRAG          | –                     | –                      | –                    | –                     | –                           | 3,851.029        | 19.158            | 3,870.187           | 3,870.187    |
| LangMem           | –                     | –                      | 982.68               | 119.48                | 1,102.16                    | –                | –                 | –                   | 1,102.16     |
| A-MEM             | 1,827.373             | 492.883                | 7,298.878            | 1,875.210             | 11,494.344                  | 10,113.252       | 57.315            | 10,170.567          | 21,664.911   |
| MemoryOS(eval)    | 1,109.849             | 333.970                | 780.807              | 645.410               | 2,870.036                   | 7,638.539        | 10.804            | 7,649.343           | 10,519.379   |
| MemoryOS(pypi)    | 1,007.729             | 294.601                | 3,037.509            | 924.962               | 5,264.801                   | 6,116.239        | 9.872             | 6,126.111           | 11,390.912   |
| Mem0              | \                     | \                      | \                    | \                     | 68,347.720                           | 4,156.850        | 13.059            | 4,169.909           | 4,169.909    |
| Mem0-g            | \                     | \                      | \                    | \                     | 69,684.818                           | 4,375.900        | 13.247            | 4,389.147           | 4,389.147    |
| LightMem(512,0.7) | 731.89                | 201.29                 | 60.45                | 3.97                  | 997.60                      | 3,997.984        | 10.259            | 4,008.243           | 5,005.843    |
| LightMem(768,0.7) | 575.36                | 189.24                 | 37.85                | 2.32                  | 804.77                      | 3,948.124        | 10.104            | 3,958.228           | 4,762.998    |
| LightMem(768,0.8) | 628.20                | 179.53                 | 41.38                | 2.76                  | 851.87                      | 4,001.759        | 10.275            | 4,012.034           | 4,863.904    |
