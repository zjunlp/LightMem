...
| A-MEM             | 64.16              | 60.71                        | 11,494.344                  | 10,170.567          | 21,664.907   | 11,754 | 67,084.33          |
...
| Method             | ACC(%) gpt-4o-mini | Memory-Con Tokens(k) Total | QA Tokens(k) total | Total(k)     | Calls  | Runtime(s) total |
|-------------------|--------------------|-----------------------------|---------------------|--------------|--------|------------------|
| FullText          | 74.87              | –                           | 60,873.076          | 60,873.076   | –      | 10,555           |
| NaiveRAG          | 66.95              | –                           | 4,271.052           | 4,271.052    | –      | 1,252           |
| LangMem           | 37.20              | 1,102.16                    | –                   | 1,102.16     | 520.62 | –               |
| A-MEM             | 56.10              | 16,267.997                  | 17,340.881          | 33,608.878   | 11,754 | 69,339.74          |
| MemoryOS(eval)    | 58.25              | 2,870.036                   | 7,649.343           | 10,519.379   | 5,534  | 26,129          |
| MemoryOS(pypi)    | 54.87              | 5,264.801                   | 6,126.111           | 11,390.004   | 10,160 | 37,912          |
| Mem0              | 61.69              | 68,347.720                  | 4,169.909           | 72,517.629   | 6,022  | 10,445          |
| Mem0-g            | 60.32              | 69,684.818                  | 4,389.147           | 74,073.965   | 6,022  | 10,926          |
| LightMem(512,0.7) | 71.95              | 997.60                      | 4,008.243           | 5,005.851    | 415    | 12,831          |
| LightMem(768,0.7) | 70.26              | 804.77                      | 3,958.228           | 4,763.005    | 295    | 11,643          |
| LightMem(768,0.8) | 72.99              | 851.87                      | 4,012.034           | 4,863.900    | 298    | 12,423          |
